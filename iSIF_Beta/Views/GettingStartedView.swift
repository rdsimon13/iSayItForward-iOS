    ...
    private var stepsSection: some View {
        VStack(alignment: .leading, spacing: 20) {
            Text("Your First Steps")
                ...
                .padding(.horizontal)
            VStack(spacing: 15) {
                FeatureCard(icon: "square.and.pencil", title: "Compose a SIF", description: "Write messages, add photos, or record voice notes.")
                FeatureCard(icon: "calendar", title: "Set the Time", description: "Choose when your message is delivered.")
                FeatureCard(icon: "paperplane.fill", title: "Send It Forward", description: "Your message is securely stored and delivered on schedule.")
            }
            .padding(.horizontal)
        }
    }
