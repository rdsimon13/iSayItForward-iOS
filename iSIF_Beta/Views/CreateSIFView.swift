...
struct CreateSIFView: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showImagePicker) {
            SIFImagePicker(attachments: $attachments)
        }
...
// MARK: - SIF Image Picker (UIKit-based)
struct SIFImagePicker: UIViewControllerRepresentable {
    ...
    class Coordinator: NSObject, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
        let parent: SIFImagePicker
        
        init(_ parent: SIFImagePicker) {
            self.parent = parent
        }
